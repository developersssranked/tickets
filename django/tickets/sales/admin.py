...
class ProductAdmin(admin.ModelAdmin):
    list_display=('start_punkt','finish_punkt','price','quantity','date')
    fields=('start_punkt','finish_punkt','price','quantity','date') #Создаем поля, которые будут отображаться в каждой записи. !Если создать внутри кортежа еще один кортеж, то значения, которые внутри подкортежа будут выводиться в одну строку.
